...
resource "aws_vpc_endpoint" "vpce-s3" {
  ...
  route_table_ids = [
    aws_route_table.rtb-eks-private1.id,
    aws_route_table.rtb-eks-private2.id,
    aws_route_table.rtb-eks-private3.id,
    aws_route_table.rtb-eks-private4.id,
    aws_route_table.rtb-eks-public1.id,
    aws_route_table.rtb-eks-public2.id,
